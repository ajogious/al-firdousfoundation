        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu fade-up m-0">
              ...
              <a href="donate-page.php" class="dropdown-item active">Donate</a>
          ...
          >
            <div class="p-lg-5 pe-lg-0">
              <div class="section-title text-start">
                <h1 class="display-5 mb-4 text-primary">Donate</h1>
              </div>
              <p class="mb-4 pb-2">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    <th>Account Name</th>
                    <td>AL-FIRDOUS HUMANITARIAN FOUNDATION ABUJA</td>
                  </tr>
                  <tr>
                    <th>Account Number (NGN)</th>
                    <td>0950147182</td>
                  </tr>
                  <tr>
                    <th>Account Number (GBP)</th>
                    <td>3000907668</td>
                  </tr>
                  <tr>
                    <th>Account Number (USD)</th>
                    <td>3000907675</td>
                  </tr>
                  <tr>
                    <th>Account Number (EUR)</th>
                    <td>3000907644</td>
                  </tr>
                  <tr>
                    <th>Bank Name</th>
